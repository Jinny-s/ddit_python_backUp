...
from day18_AI.TEAM1.snake import SCREEN_SIZE, PIXEL_SIZE, Snake
from day18_AI.TEAM1.genome import Genome
...
while True:
  ...
  print('===== %sth Generation\tBest Fitness %s =====' % (n_gen, genomes[0].fitness))
